...
//---------------------------Constructor---------------------------
Particle::Particle(int type_arg) : x{0., 0., 0.}, v{0., 0., 0.}, f{0., 0., 0.}, old_f{0., 0., 0.}, type{type_arg} {
...
Particle::Particle(const Vector &x_arg, const Vector &v_arg, double m_arg, int type_arg) : x{x_arg}, v{v_arg},
                                                                                           f{0., 0., 0.},
                                                                                           old_f{0., 0., 0.}, m{m_arg},
                                                                                           type{type_arg} {
  std::cout << "Particle generated!" << std::endl;
